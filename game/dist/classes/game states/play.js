...
export class PlayState extends GameState {
    ...
    constructor(states) {
        ...
        this._coinui = document.getElementById("uicoinelemet");
        this._lifeui = document.getElementById("uilifeelemet");
    }
    pause() {
        this._pause = true;
    }
    ...
    enter() {
        ...
        //Уровень Финал
        let levelfinalTime = (render.VIRTUAL_WIDTH + level3Background[0].x - playerStartPossitionX + render.VIRTUAL_WIDTH + 475 - playerHitboxW + 95) / (gamespeed * 0.5) - render.VIRTUAL_WIDTH / gamespeed - render.VIRTUAL_WIDTH / gamespeed;
