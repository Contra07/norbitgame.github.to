...
export class FlyingObjects extends GameObject {
    ...
    _createParams;
    _objectSpeed;
    constructor(isSpawn, spawnTime, dx, h, w, levelNumber, fH, pH, color, sprite) {
        super();
        ...
        this._refObject = new FlyingObject(FlyingObjects.randomPositionY(fH, levelNumber, pH, pH * 0.2), h, w, color, sprite);
        this._createParams = {
            height: h,
            width: w,
            floorHeight: fH,
